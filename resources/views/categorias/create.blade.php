...
<html lang="en">
<head>
    <!-- Encabezado y enlaces a CSS y otros recursos si es necesario -->
</head>
<body>
    <!DOCTYPE html>
<html lang="en">
    ...
    <nav>
        <ul class="nav-links">
            ...
            @auth
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('categorias.create') ? 'active' : '' }}" href="{{ route('categorias.create') }}">Crear una nueva categoria</a>
                </li>
                <li class="nav-item">
...
@auth
    ...
    <!-- Agrega un modal para mostrar la lista de categorías -->
